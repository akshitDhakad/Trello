...
export const metadata: Metadata = {
  title: "Trello SignIn Page",
  description: "This is Signin Page Trello Dashboard.",
};
        ...
        <div className="h-full w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <form action="#">
            <div className="p-6.5">
              ...
              <button className="mt-5 flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                <Image
                  height={24}
                  width={24}
