# Tello-Admin Dashboard Template

Tello is a free and open-source admin dashboard template built on **Next.js and Tailwind CSS** providing developers with everything they need to create a feature-rich and data-driven: back-end, dashboard, or admin panel solution for any sort of web project.
...
### Trello PRO vs Tello Next.js FREE Comparison 📊

#### [Trello Next.js PRO](https://nextjs-demo.tailadmin.com/)
...
#### [Trello Next.js FREE](https://free-nextjs-demo.tailadmin.com/)
- 1 Unique Dashboard
...
Trello Next.js is a free dashboard template, which uses Tailwind CSS, is a great starting point for dashboard UI. This template uses the Next.js JavaScript framework and the easy-to-use Tailwind CSS framework. The Tailwind CSS and Next.js Dashboard Template comes with ready-made components like navigation menus, charts, tables, and forms. These components can be easily adjusted and added to any Next.js web application.
...
### 📄 License
Trello Next.js Free is 100% free and open-source; feel free to use it with your personal and commercial projects.
...
- Initial release of Trello Next.
